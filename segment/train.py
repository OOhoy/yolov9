...
def get_args():
    ...
    parser.add_argument('--weights', type=str, default='yolov9.pt', help='initial weights path')
    parser.add_argument('--hyp', type=str, default='hyp.scratch-high.yaml', help='hyperparameters path')
